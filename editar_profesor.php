...
$sql = "SELECT $campo FROM profesores WHERE rut = '$rut'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE profesores SET $campo = '$nuevoValor' WHERE rut = '$rut'";
    if ($conn->query($sql) === TRUE) {
        echo "Registro actualizado exitosamente";
        sleep(1);
        header("Location: home_profesores.php");  // Redirigir al panel de control de profesores después de la actualización
    } else {
